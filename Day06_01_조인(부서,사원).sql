/*
    ...
    3. 조인 성능 향상을 위해서 가급적 드라이브(DRIVE) 테이블을 먼저 작성한다. 드리븐(DRIVEN) 테이블을 나중에 작성한다.    
*/
...
DELETE FROM EMPLOYEE_TBL WHERE EMP_NO = 1005;    -- EMP_NO가 PK : PK를 조건으로 사용하면 인덱스를 타기 때문에 빠르다.
