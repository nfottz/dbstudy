...
INSERT INTO BOOK_TBL(BOOK_ID, BOOK_NAME, PUBLISHER, PRICE)
     VALUES (BOOK_SEQ.NEXTVAL, '축구의 역사', '굿스포츠', 7000);
INSERT INTO BOOK_TBL(BOOK_ID, BOOK_NAME, PUBLISHER, PRICE)
    VALUES (BOOK_SEQ.NEXTVAL, '축구 아는 여자', '나이스북', 13000);
INSERT INTO BOOK_TBL(BOOK_ID, BOOK_NAME, PUBLISHER, PRICE)
    VALUES (BOOK_SEQ.NEXTVAL, '축구의 이해', '대한미디어', 22000);
INSERT INTO BOOK_TBL(BOOK_ID, BOOK_NAME, PUBLISHER, PRICE)
    VALUES (BOOK_SEQ.NEXTVAL, '골프 바이블', '대한미디어', 35000);
INSERT INTO BOOK_TBL(BOOK_ID, BOOK_NAME, PUBLISHER, PRICE)
    VALUES (BOOK_SEQ.NEXTVAL, '피겨 교본', '굿스포츠', 6000);
INSERT INTO BOOK_TBL(BOOK_ID, BOOK_NAME, PUBLISHER, PRICE)
    VALUES (BOOK_SEQ.NEXTVAL, '역도 단계별 기술', '굿스포츠', 6000);
INSERT INTO BOOK_TBL(BOOK_ID, BOOK_NAME, PUBLISHER, PRICE)
    VALUES (BOOK_SEQ.NEXTVAL, '야구의 추억', '이상미디어', 20000);
INSERT INTO BOOK_TBL(BOOK_ID, BOOK_NAME, PUBLISHER, PRICE)
    VALUES (BOOK_SEQ.NEXTVAL, '야구를 부탁해', '이상미디어', 13000);
INSERT INTO BOOK_TBL(BOOK_ID, BOOK_NAME, PUBLISHER, PRICE)
    VALUES (BOOK_SEQ.NEXTVAL, '올림픽 이야기', '삼성당', 7500);
INSERT INTO BOOK_TBL(BOOK_ID, BOOK_NAME, PUBLISHER, PRICE)
    VALUES (BOOK_SEQ.NEXTVAL, '올림픽 챔피언', '나이스북', 13000);
...
INSERT INTO CUSTOMER_TBL(CUSTOMER_ID, CUSTOMER_NAME, ADDRESS, PHONE)
    VALUES (CUSTOMER_SEQ.NEXTVAL, '박지성', '영국', '000-000-000');
INSERT INTO CUSTOMER_TBL(CUSTOMER_ID, CUSTOMER_NAME, ADDRESS, PHONE)
    VALUES (CUSTOMER_SEQ.NEXTVAL, '김연아', '대한민국', '111-111-111');
INSERT INTO CUSTOMER_TBL(CUSTOMER_ID, CUSTOMER_NAME, ADDRESS, PHONE)
    VALUES (CUSTOMER_SEQ.NEXTVAL, '장미란', '대한민국', '222-222-222');
INSERT INTO CUSTOMER_TBL(CUSTOMER_ID, CUSTOMER_NAME, ADDRESS, PHONE)
    VALUES (CUSTOMER_SEQ.NEXTVAL, '추신수', '미국', '333-333-333');
INSERT INTO CUSTOMER_TBL(CUSTOMER_ID, CUSTOMER_NAME, ADDRESS, PHONE)
    VALUES (CUSTOMER_SEQ.NEXTVAL, '박세리', '대한민국', NULL);
...
INSERT INTO ORDER_TBL(ORDER_ID, CUSTOMER_ID, BOOK_ID, AMOUNT, ORDER_DATE)
    VALUES(TO_CHAR(SYSDATE, 'YYMMDD')|| '-' ||ORDER_SEQ.NEXTVAL, 1000, 1, 1, '20/07/01');
INSERT INTO ORDER_TBL(ORDER_ID, CUSTOMER_ID, BOOK_ID, AMOUNT, ORDER_DATE)
    VALUES(TO_CHAR(SYSDATE, 'YYMMDD')|| '-' ||ORDER_SEQ.NEXTVAL, 1000, 3, 2, '20/07/03');
INSERT INTO ORDER_TBL(ORDER_ID, CUSTOMER_ID, BOOK_ID, AMOUNT, ORDER_DATE)
    VALUES(TO_CHAR(SYSDATE, 'YYMMDD')|| '-' ||ORDER_SEQ.NEXTVAL, 1001, 5, 1, '20/07/03');
INSERT INTO ORDER_TBL(ORDER_ID, CUSTOMER_ID, BOOK_ID, AMOUNT, ORDER_DATE)
    VALUES(TO_CHAR(SYSDATE, 'YYMMDD')|| '-' ||ORDER_SEQ.NEXTVAL, 1002, 6, 2, '20/07/04');
INSERT INTO ORDER_TBL(ORDER_ID, CUSTOMER_ID, BOOK_ID, AMOUNT, ORDER_DATE)
    VALUES(TO_CHAR(SYSDATE, 'YYMMDD')|| '-' ||ORDER_SEQ.NEXTVAL, 1003, 7, 3, '20/07/05');
INSERT INTO ORDER_TBL(ORDER_ID, CUSTOMER_ID, BOOK_ID, AMOUNT, ORDER_DATE)
    VALUES(TO_CHAR(SYSDATE, 'YYMMDD')|| '-' ||ORDER_SEQ.NEXTVAL, 1000, 2, 5, '20/07/07');
INSERT INTO ORDER_TBL(ORDER_ID, CUSTOMER_ID, BOOK_ID, AMOUNT, ORDER_DATE)
    VALUES(TO_CHAR(SYSDATE, 'YYMMDD')|| '-' ||ORDER_SEQ.NEXTVAL, 1003, 8, 2, '20/07/07');
INSERT INTO ORDER_TBL(ORDER_ID, CUSTOMER_ID, BOOK_ID, AMOUNT, ORDER_DATE)
    VALUES(TO_CHAR(SYSDATE, 'YYMMDD')|| '-' ||ORDER_SEQ.NEXTVAL, 1002, 10, 2, '20/07/08');
INSERT INTO ORDER_TBL(ORDER_ID, CUSTOMER_ID, BOOK_ID, AMOUNT, ORDER_DATE)
    VALUES(TO_CHAR(SYSDATE, 'YYMMDD')|| '-' ||ORDER_SEQ.NEXTVAL, 1001, 10, 1, '20/07/09');
INSERT INTO ORDER_TBL(ORDER_ID, CUSTOMER_ID, BOOK_ID, AMOUNT, ORDER_DATE)
    VALUES(TO_CHAR(SYSDATE, 'YYMMDD')|| '-' ||ORDER_SEQ.NEXTVAL, 1002,  6, 4, '20/07/10');
...
SELECT O.ORDER_ID AS 구매번호, C.CUSTOMER_NAME AS 구매자, B.BOOK_NAME AS 책이름
     , B.PRICE AS 판매가격, O.ORDER_DATE AS 주문일사
  FROM CUSTOMER_TBL C INNER JOIN ORDER_TBL O
    ON C.CUSTOMER_ID = O.CUSTOMER_ID INNER JOIN BOOK_TBL B
    ON O.BOOK_ID = B.BOOK_ID
 WHERE O.ORDER_DATE 
